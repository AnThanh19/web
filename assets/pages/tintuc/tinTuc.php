                                    ...
                                    echo"<div class='col l-4 m-4 c-6'>   
                                            <ul class='content-event-list'>
                                                <li class='content-event-item'>
                                                    <a href='../chitiet/chiTietTinTuc.php?makm=$row[0]' class='content-event-link'>
                                                        ...
                                                        <p class='event-link-info'>Chương trình khuyến mãi giảm giá cho khách hàng khi mua vé xem phim online tại trang web từ ngày $row[1] tới ngày $row[2]</p>
                                                    </a>
                                                </li>
                                            </ul> 
                                        </div> ";
